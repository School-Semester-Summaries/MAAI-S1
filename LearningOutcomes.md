## 2.5 Leeruitkomsten
Bij de master Applied AI werk je in een jaar toe naar een eindniveau dat is beschreven in een viertal
leeruitkomsten.
- A. Contextualiseren en Ontwerpen
- B. Ontwikkelen / Modelleren
- C. Evalueren
- D. Zelfsturing

Deze vier leeruitkomsten staan hieronder verder beschreven en zijn weer onderverdeeld in
meerdere beoordelingscriteria. Zowel in het eerste, als het tweede blok worden alle
beoordelingscriteraia geëvalueerd.
In het eerste blok krijg je nog relatief veel sturing van de docenten en naarmate je verder in de
opleiding komt, hoe meer zelfstandigheid van je wordt verwacht. Verder is het eerste project qua
complexiteit minder complex dan projecten later in de opleiding. Op deze manier werk je langzaam
toe naar het eindniveau van de opleiding.

### A. CONTEXTUALISEREN EN ONTWERPEN
Je ontwerpt AI-oplossingen en handelt daarbij vanuit expliciet gemaakte ethische normen en waarden. Voor
...
<table>
  <tr>
    <td>A1</td>
    <td>Je doet onderzoek om het probleem en oplossingsrichtingen in de context in kaart te brengen, herformuleert het vraagstuk, weegt en toetst de belangen van de opdrachtgever, eindgebruiker en andere belanghebbenden.</td>
  </tr>
  <tr>
    <td>A2</td>
    <td>Je stelt voor een AI-oplossing juridische, ethische, organisatorische, functionele en technische requirements op.</td>
  </tr>
  <tr>
    <td>A3</td>
    <td>Je ontwerpt en verfijnt de kwaliteit van het ontwerp door AI-specifieke ontwerprichtlijnen toe te passen en daarbij te kijken naar aspecten zoals vertrouwen, veiligheid, privacy, elegante foutafhandeling (waaronder edge cases), feedback en controlemechanismen.</td>
  </tr>
  <tr>
    <td>A4</td>
    <td>Je onderbouwt in hoeverre AI geschikt is voor een gegeven vraagstuk en maakt een weloverwogen keuze welke mate van automatisering daarbij gewenst is, gelet op technische, maatschappelijke en ethische aspecten.</td>
  </tr>
</table>

### B. ONTWIKKELEN EN MODELLEREN
Je ontwikkelt AI-oplossingen. Hierbij toon je niet alleen diep begrip van de technologie, maar weet wanneer
