...
|------------------|-----------|----------|
| A2 | • (+) vanuit de opdracht en data bepaalt wanneer het model ‘voldoende genoeg’ is.<br>• (+-) Je had kunnen opmerken dat met zo een scheve verdeling, zoveel klasses en zo weinig waarnemingen niet elke klasse voldoende gerepresenteerd kan zijn.<br>• (–) Je had kunnen opmerken dat het aantal waarnemingen laag is ten opzichte van het aantal variabelen. | Hier is nog werk nodig |
