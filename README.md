...
| 03/10/2025 | Marcio Fuckner | Be more clear and specific in what you want to do, right now it's still very vague. What is exactly your idea? What do you mean with model types? Focus on a mitigation technique to keep it small and realistic to realise. Also a negative point was the fact that my presentation was too short. | I will implement this feedback in my paper  | I agree on all points except for the length of the presentation since it wasn't stated how long the presentation should have been | The paper if it's done |
...
| 10/10/2025 | Marcio Fuckner | A ton of feedback, in contrast to the m1a feedback, I decided not to add all of the feedback in here since it makes the table look very chaotic | I read through the feedback and modified my approach accordingly | - | Feedback on PvA Class 1 (DLO) |
